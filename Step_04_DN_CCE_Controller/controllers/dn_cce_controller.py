# controllers/dn_cce_controller.py
...
class DNCceController:
    """
    DN/CCE compressed action-selection controller.

    It does not scan all 61 actions.
    It builds a small candidate set using DN-risk geometry.
    """
